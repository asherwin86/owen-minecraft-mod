...
4. Download [`dist/speedtweaks-1.1.0.jar`](dist/speedtweaks-1.1.0.jar) from this repo.
5. Put both jars (Fabric API and `speedtweaks-1.1.0.jar`) in your `mods` folder:
...
The jar is written to `build/libs/speedtweaks-1.1.0.jar`.
